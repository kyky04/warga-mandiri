...
public class Toko {
    ...
    private String pesan_pembuka;

    @SerializedName("nama_kota")
    private String namaKota;

    public String getPesan_pembuka() {
        return pesan_pembuka;
    }

    public void setPesan_pembuka(String pesan_pembuka) {
        this.pesan_pembuka = pesan_pembuka;
    }
