...
public class AdapterVoucher extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVoucher(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            view.tvTanggal.setText(o.getStartAt()+" sampai "+ o.getExpireAt());
            view.tvJumlahPotongan.setText("potongan :"+Tools.getFormattedPrice((double) o.getJumlahPotongan(),ctx));
            view.tvMinimalBelanja.setText("minimal : "+Tools.getFormattedPrice((double) o.getJumlahPotongan(),ctx));
    ...
    public void add(DataItemVoucher dataItemRapatK3) {
    ...
    public void remove(DataItemVoucher Memo) {
