...
public class AdapterMember extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnItemClick {
        void onItemEditClick(int pos, DataItemMember dataItemBanner);

        void onItemDeleteClick(int pos, DataItemMember dataItemBanner);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            final DataItemMember o = items.get(position);
            view.nama.setText(o.getName());
    ...
    public void add(DataItemMember dataItemRapatK3) {
    ...
    public void remove(DataItemMember Memo) {
